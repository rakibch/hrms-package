...
// node_modules/laravel-precognition-vue/dist/index.js
var useForm = (method2, url, inputs, config = {}) => {
  ...
  let form = {
    ...cloneDeep_default(originalData),
    data() {
      const data = cloneDeep_default(toRaw(form));
...
// node_modules/laravel-precognition-vue-inertia/dist/index.js
var useForm2 = (method2, url, inputs, config = {}) => {
  const inertiaForm = C(inputs);
  ...
  const form = Object.assign(inertiaForm, {
    ...
    validate(name, config2) {
      ...
      if (typeof config2 === "object") {
        config2.onValidationError = config2.onValidationError ?? (config2 == null ? void 0 : config2.onError);
      }
      if (typeof name === "undefined") {
...
lodash-es/lodash.js:
   ...
   *)
*/
//# sourceMappingURL=laravel-precognition-vue-inertia.js.map

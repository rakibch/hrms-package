...
// Constants for achievement-related validations
     ...
     */
    public function achievementRulesUpdate(): array
    {
        return [
// Education validation
            'achievements.education' => ['array', 'nullable'],
            'achievements.education.*.id' => [
                'nullable',
                'integer',
                Rule::exists(EducationalInformation::class, 'id'),
            ],
            'achievements.education.*.employee_id' => [
                'nullable',
                'integer',
            ...
            'achievements.education.*._delete' => ['nullable', 'boolean'],

// Work Experience validation
            'achievements.work_experience' => ['array', 'nullable'],
            'achievements.work_experience.*.id' => [
                'nullable',
                'integer',
                Rule::exists(ProfessionalExperience::class, 'id'),
            ],
            'achievements.work_experience.*.employee_id' => [
                'nullable',
                'integer',
                Rule::exists(Employee::class, 'id'),
            ],
            ...
            'achievements.work_experience.*._delete' => ['nullable', 'boolean'],
// Certification validation
            'achievements.certifications' => ['array', 'nullable'],
            'achievements.certifications.*.id' => [
                'nullable',
                'integer',
                Rule::exists(Certification::class, 'id'),
            ],
            'achievements.certifications.*.employee_id' => [
                'nullable',
                'integer',
                Rule::exists(Employee::class, 'id'),
            ],
            ...
            'achievements.certifications.*.certificate_urls' => ['nullable', 'string'],
            'achievements.certifications.*._delete' => ['nullable', 'boolean'],

...
use Softzino\EmployeeManagementApi\Rules\ContactRules;
...
{
    use AddressRules, PersonalInfoRules, EmergencyContactRules, OfficialInfoRules, ContactRules, AchievementRules, WorkLocationRules;

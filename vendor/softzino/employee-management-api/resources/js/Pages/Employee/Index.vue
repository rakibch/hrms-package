...
const handleRowAction = async (payload: {
  ...
  if (payload.action === 'view') {
    ...
    router.visit(`employee/${payload.rowData.id}/employee-timeline`, {
      ...
      router.visit(route('employee.edit', payload.rowData.id), {
          preserveScroll: true,
      });
  } else {
      ...
      >
        <template #table-col-name="{ rowData }">
          <div class="flex items-center gap-2">
            ...
            <div>
              <h3 class="text-[14px] font-medium leading-[20px] text-gray-800">
                {{ rowData.name }}
              </h3>
        ...
        <template #table-col-employment_status="{ rowData }">
          <Chip
            ...
            :severity="getSeverityByStatus(rowData.employment_status)"
          />
        </template>
        <template #table-col-profile_status="{ rowData }">
          <Chip
            ...
            :severity="
              rowData.profile_status === 'Complete' ? 'success' : 'secondary'
            "
          />
        </template>
                ...
                <template #content>
                  <div class="w-[200px] px-0.5 py-1">
                    ...
                    <Button
                      ...
                      "
                    >
                      <SvgIcon name="timeline" height="16px" width="16px" />

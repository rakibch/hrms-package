...
/**
 * Strategy for applying a 'less than or equals' filter.
 */
class LessThanOrEqualsStrategy implements FilterStrategyContract
{
    /**
     * Apply the 'less than or equals' filter strategy.
     *
